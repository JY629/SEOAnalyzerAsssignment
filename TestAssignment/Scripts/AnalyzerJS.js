function clearResult() {
    ...
    $('#external-source').val('');
    $('#analyze-object-title').addClass('hidden');
}
...
$(function () {
    ...
    function addTitle(jsonData) {
        var analisysTitle = $('#analyze-object-title');
        if (jsonData.ExternalSourceUrl) {
            analisysTitle.find('span').html(jsonData.ExternalSourceUrl);
        }
        else if ($('#internal-source').val()) {
            $('#analyze-object-title').find('span').html(messages.textAreInput);
        }
        else {
            $('#analyze-object-title').find('span').html(messages.emptyInputs);
        }

        $('#analyze-object-title').removeClass('hidden');
    }
